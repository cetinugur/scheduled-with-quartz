...
{
    public class MiddleWareExampleJob2 : IAppJobBase
    {
        ...
        {
            Console.WriteLine($"{DateTime.Now}{nameof(MiddleWareExampleJob2)} trigged.");
            ...
            Console.WriteLine($"{DateTime.Now}{nameof(MiddleWareExampleJob2)} ended.");
